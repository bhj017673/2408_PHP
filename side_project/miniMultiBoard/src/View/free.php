...
<body>
    ...
    <main>
        <div class="card">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detaileModal">
                상세
            </button>
            </div>
        </div>
        ...
        <div class="card">
            <img src="./img/nongdam.jpeg" class="card-img-top object-fit-cover" style="height: 300px;" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detaileModal">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <p>살려주세요.</p>
                <br>
                <img src="./img/help.jfif" class="object-fit-cover" style="height: 300px;" alt="">
            </div>
